...
export const plans: Plan[] = [
  // =================== ESSENCIAL =================== //
  {
    ...
    focus_desc: "Tutores que buscam cuidado eficiente, orientação confiável e praticidade no dia a dia do seu animal.",
    price: 39.90,
    free_consultations: 1,
    perks: [
      { icon: "i-ph-dog", label: "Cadastro de até 5 animais (cães e gatos)" },
  ...
  // =================== CARE PLUS =================== //
  {
    ...
    focus_desc: "Tutores que desejam mais suporte, comodidade e benefícios para cuidar melhor do seu animal.",
    price: 79.90,
    ...
    perks: [
      ...
      { icon: "i-ph-first-aid-kit", label: "Envio de 1 Mini Kit Emergência Animal: Anual" },
      { icon: "i-ph-house-line", label: "Atendimento Veterinário Domiciliar: 5% de desconto em todos os atendimentos domiciliares" },
      { icon: "i-ph-cat", label: "Encontros ConectaVet: Participação em encontros presenciais exclusivos com aulas práticas e socialização animal" },
  ...
  // =================== SUPER PREMIUM =================== //
  {
    ...
    focus_desc: "Tutores que querem o melhor em exclusividade, benefícios e mimos para seu animal.",
    price: 149.90,
    free_consultations: 4,
    perks: [
      { icon: "i-ph-exclamation-mark", label: "Tudo incluso no Essencial e Care Plus" },
      { icon: "i-ph-stethoscope", label: "Consulta Virtual ou Pronto Atendimento: 4 por mês (inclui animais exóticos/silvestres)" },
      { icon: "i-ph-first-aid-kit", label: "Envio de 1 Mini Kit Emergência Animal Premium: Anual" },
      ...
      { icon: "i-ph-lego", label: "MAFFYBOX: Envio mensal de brinquedos, petiscos e itens de moda animal ergonômica direto para sua casa" },
      { icon: "i-ph-house-line", label: "Ultrassonografia em Domicílio: Tarifa VIP com desconto exclusivo (1x/ano)" },
      { icon: "i-ph-seal-percent", label: "Consultas Virtuais Extras: Coparticipação fixa de apenas R$ 19,00" }
    ]
  },
]
